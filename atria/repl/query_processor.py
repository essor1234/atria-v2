...
if TYPE_CHECKING:
    ...
    from atria.core.context_engineering.tools.implementations import FileOperations
    from atria.ui_textual.formatters_internal.output_formatter import OutputFormatter
    from atria.ui_textual.components import StatusLine
...
class QueryProcessor:
    ...
    def __init__(
        ...
        from atria.core.context_engineering.context_picker import ContextPicker
    ...
    def _trigger_topic_detection(self, query: str) -> None:
        ...
        if self._topic_detector is None:
            try:
                from atria.core.context_engineering.history import TopicDetector
    ...
    def process_query(
        ...
        if plan_requested:
            plan_path = self.mode_manager.get_plan_file_path() or "~/.atria/plans/plan.md"
            messages.append(
                {
                    "role": "user",
