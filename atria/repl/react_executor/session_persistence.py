...
from atria.models.message import ChatMessage, Role, ToolCall as ToolCallModel
...
class SessionPersistenceMixin:
    ...
    def _add_assistant_message(self, content: str, raw_content: Optional[str]):
        ...
        run_sync(self.session_manager.add_message(assistant_msg, self.config.auto_save_interval))
