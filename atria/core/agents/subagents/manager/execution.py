...
if TYPE_CHECKING:
    ...
    from atria.core.agents.subagents.specs import CompiledSubAgent
...
class ExecutionMixin:
    ...
    def execute_subagent(
        ...
        if docker_handler is not None:
            ...
            from atria.core.docker.tool_handler import DockerToolRegistry
        ...
        if working_dir is not None or docker_handler is not None:
            from atria.core.agents import MainAgent
    ...
    def _parse_ask_user_questions(self, questions_data: list) -> list:
        ...
        """
        from atria.core.context_engineering.tools.implementations.ask_user_tool import (
            Question,
            QuestionOption,
        )
