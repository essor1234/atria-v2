...
from atria.core.context_engineering.tools.implementations.search_excludes import (
    DEFAULT_SEARCH_EXCLUDES,
)

__all__ = ["FileOperations", "DEFAULT_SEARCH_EXCLUDES"]
...
class FileOperations:
    ...
    def gitignore(self):
        ...
        if self._gitignore is None:
            try:
                from atria.core.utils.gitignore import GitIgnoreParser
