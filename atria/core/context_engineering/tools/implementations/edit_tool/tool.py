...
from atria.models.operation import EditResult, Operation
from atria.core.context_engineering.tools.implementations.base import BaseTool
from atria.core.context_engineering.tools.implementations.diff_preview import DiffPreview, Diff
from atria.core.context_engineering.tools.implementations.edit_tool.replacers import (
    _REPLACER_CHAIN,
    _normalize_line_endings,
)

if TYPE_CHECKING:
    from atria.core.runtime.task_monitor import TaskMonitor
