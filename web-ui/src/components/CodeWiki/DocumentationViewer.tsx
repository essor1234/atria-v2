...
const mockWikiPages: WikiPage[] = [
  {
    id: 'overview',
    title: 'Atria Architecture Overview',
    type: 'overview',
    description: 'High-level architecture and design principles of Atria',
    lastModified: '2 hours ago',
    importance: 10,
    content: `# Atria Architecture Overview

Atria (Software Engineering CLI) is an AI-powered command-line tool designed to enhance developer productivity through intelligent code assistance and automation.
...
- **Performance**: Async execution with intelligent caching and optimization`,
    relatedFiles: ['atria/core/agent.py', 'atria/web/server.py', 'atria/tools/registry.py'],
...
The agent system is the core intelligence layer of Atria, responsible for understanding user intent and executing complex coding tasks through coordinated tool usage.
...
6. **Response Generation**: Providing clear, actionable responses`,
    relatedFiles: ['atria/core/agent.py', 'atria/agents/normal.py', 'atria/agents/debug.py'],
...
The web interface provides a modern, responsive UI for Atria with real-time communication capabilities and session management.
...
- **Configuration Management**: Dynamic settings and preferences`,
    relatedFiles: ['atria/web/server.py', 'atria/web/websocket.py', 'atria/web/state.py'],
  ...
  },
  {
    ...
    title: 'API Reference',
    type: 'reference',
    description: 'Complete API documentation for Atria components',
    lastModified: '6 hours ago',
    importance: 7,
    content: `# API Reference

Complete API documentation for Atria components, including REST endpoints, WebSocket messages, and internal APIs.
...
- \`approval_required\` - User approval needed`,
    relatedFiles: ['atria/web/routes/chat.py', 'atria/web/routes/sessions.py', 'atria/web/config.py'],
                        ...
                        <div className="space-y-2 text-sm text-green-800">
                          {selectedDoc.wikiPage.diagrams.map((diagram, index) => (
                            <div key={index} className="flex items-center gap-2">
                              <ChartBarIcon className="w-4 h-4 flex-shrink-0" aria-hidden="true" />
                              <span>{diagram}</span>
                            </div>
                          ))}
                        </div>
