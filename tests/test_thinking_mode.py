...
from atria.core.context_engineering.tools.handlers.thinking_handler import (
    ThinkingHandler,
    ThinkingBlock,
    ThinkingLevel,
)
...
class TestThinkToolRemoved:
    ...
    def test_think_not_in_builtin_schemas(self):
        ...
        from atria.core.agents.components.schemas import _BUILTIN_TOOL_SCHEMAS
    ...
    def test_think_not_in_planning_tools(self):
        ...
        from atria.core.agents.components import PLANNING_TOOLS
...
class TestCallbackProtocol:
    ...
    def test_forwarding_callback_forwards_on_thinking(self):
        ...
        from atria.ui_textual.callback_interface import ForwardingUICallback
...
class TestStyleTokens:
    ...
    def test_thinking_tokens_exist(self):
        ...
        from atria.ui_textual.style_tokens import THINKING, THINKING_ICON
...
class TestThinkingModeReminder:
    ...
    def test_no_placeholder_leaves_content_unchanged(self):
        ...
        from atria.repl.query_enhancer import QueryEnhancer
...
class TestThinkingModeSchemaFiltering:
    ...
    def test_think_tool_never_in_schemas(self):
        ...
        from atria.core.agents.components import ToolSchemaBuilder
...
class TestThinkingModelSelection:
    ...
    def test_thinking_model_used_when_configured_and_visible(self):
        ...
        from atria.core.agents.main_agent import MainAgent
...
class TestThinkingPromptBuilder:
    ...
    def test_thinking_prompt_builder_loads_prompt(self):
        ...
        from atria.core.agents.components import ThinkingPromptBuilder

        mock_return = (
            "Thinking Mode: You are in thinking mode.\nWorking directory context will be added."
        )
        with (
            patch("atria.core.agents.components.prompts.builders.load_prompt") as mock_load,
            patch("atria.core.agents.prompts.loader.load_prompt") as mock_loader_load,
        ):
...
class TestHTTPClientFactory:
    ...
    def test_openai_client_creation(self):
        ...
        from atria.core.agents.components import create_http_client_for_provider
