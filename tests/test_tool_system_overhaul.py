...
class TestToolPolicy:
    def test_import(self):
        from atria.core.context_engineering.tools.tool_policy import TOOL_GROUPS, PROFILES
...
class TestScheduleTool:
    def test_import(self):
        from atria.core.context_engineering.tools.implementations.schedule_tool import ScheduleTool
    ...
    def test_list_empty(self):
        ...
        with patch(
            "atria.core.context_engineering.tools.implementations.schedule_tool._SCHEDULES_FILE",
...
class TestMessageTool:
    def test_import(self):
        from atria.core.context_engineering.tools.implementations.message_tool import MessageTool
...
class TestMiddleware:
    def test_import(self):
        from atria.core.context_engineering.tools.middleware import (
            MiddlewareChain,
        )
    ...
    def test_empty_chain(self):
        from atria.core.context_engineering.tools.middleware import MiddlewareChain
    ...
    def test_builtin_sanitizer_middleware(self):
        from atria.core.context_engineering.tools.middleware import ResultSanitizerMiddleware
        from atria.core.context_engineering.tools.context import ToolExecutionContext
...
class TestAuthRotation:
    def test_import(self):
        from atria.core.agents.components.api.auth_rotation import AuthProfileManager
...
class TestPluginHooks:
    def test_import(self):
        from atria.core.hooks.plugin_hooks import PluginHookManager
    ...
    def test_load_plugin_from_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            plugin_dir = Path(tmpdir) / ".atria" / "plugins"
